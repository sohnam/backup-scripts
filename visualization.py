...
## xgb_only
rf1 = pd.read_csv('/home/ansohn/Python/Results/gametes/xgb/xgb_a10_all.txt', sep='\t')
rf2 = pd.read_csv('/home/ansohn/Python/Results/gametes/xgb/xgb_a100_all.txt', sep='\t')
rf3 = pd.read_csv('/home/ansohn/Python/Results/gametes/xgb/xgb_a1000_all.txt', sep='\t')
rf4 = pd.read_csv('/home/ansohn/Python/Results/gametes/xgb/xgb_a5000_all.txt', sep='\t')
...
experiment_data = pd.concat([ekf_all, mdr_all, rf_all, pred_all])
...
#    break
    ...
    sb.boxplot(data=group, x='Experiment', y='Score',
               ...
               order=['mdr_only', 'xgb_only', 'ekf_mdr', 'mdr_pred'])
